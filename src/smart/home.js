      ...
      <div className="row">
        <div className="col s6">
          <div className="row padded">
            <img className="circle responsive-img" alt="kitten" src="http://static.tumblr.com/75014d3825fb53985bef1e901290f087/ard7iy9/9z0nb1uy6/tumblr_static_8t1b8ns3x14wg0084sgkkckgw.jpg" />
          </div>
        </div>
        <div className="col s6">
          <div className="row padded">
